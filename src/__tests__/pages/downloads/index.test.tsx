...
describe("Client downloads page", () => {
	...
	beforeEach(() => {
		...
		getAllOptions.mockReturnValue({
			data: { siteName: "ZTNET", planetDownloadAvailable: true },
			isLoading: false,
		});
	...
	it("disables download when the active Planet was not generated by this server", () => {
		getAllOptions.mockReturnValue({
			data: {
				siteName: "ZTNET",
				planetId: 1,
		...
		expect(
			screen.getByText("A Planet file generated by this server is not available."),
		).toBeInTheDocument();
	});
